...
export default function LoginSplit() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // role là số nguyên: Admin=3, Tutor=2, Student=1
      if (user.role === 3) {
    ...
    <>
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#d4efe1] via-[#fdf6e3] to-[#f4d8e6] p-4 font-body">
        <div className="w-full max-w-4xl bg-white rounded-[2rem] shadow-2xl flex flex-col md:flex-row overflow-hidden border border-[#e2d5c1]">
          ...
          <div className="w-full md:w-1/2 bg-[#b0a18e] p-10 md:p-14 flex flex-col justify-center relative">
            ...
            <div className="relative z-10 w-full max-w-sm mx-auto">
              ...
              <form onSubmit={handleLogin} className="space-y-6">
                ...
                {error && (
                  <p className="text-red-100 bg-red-500/30 px-4 py-2 rounded-xl text-center text-sm">
                    {error}
                  </p>
                )}
          ...
          {/* CỘT PHẢI: TRANG TRÍ */}
          <div className="w-full md:w-1/2 bg-[#fffdf7] p-10 md:p-14 flex-col justify-center items-center relative overflow-hidden hidden md:flex">
            <div className="absolute top-[-10%] right-[-10%] w-64 h-64 rounded-full bg-gradient-to-br from-[#f4d8e6] to-[#e2c6d5] opacity-80 blur-[2px]" />
            <div className="absolute top-[15%] right-[25%] w-16 h-16 rounded-full bg-[#d4efe1] shadow-md" />
            <div className="absolute top-[8%] left-[20%] w-8 h-8 rounded-full bg-[#e2d5c1]" />
            <div className="absolute top-[40%] left-[-10%] w-32 h-32 rounded-full border-[12px] border-[#f4d8e6] opacity-60" />
            <div className="absolute top-[60%] right-[10%] w-12 h-12 rounded-full bg-[#b0a18e] shadow-inner" />
            <div className="absolute bottom-[-15%] left-[10%] w-48 h-48 rounded-full border-[20px] border-[#d4efe1] opacity-70" />
            <div className="absolute bottom-[20%] left-[30%] w-6 h-6 rounded-full bg-[#8c7355]" />
            <div className="absolute bottom-[5%] right-[5%] w-24 h-24 rounded-full bg-gradient-to-tl from-[#e2d5c1] to-[#fdf6e3] shadow-lg" />
